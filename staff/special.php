<?php 
    ...
    if(isset($_POST['approve'])){
        ...
        $sql = "UPDATE Special_Exam SET status = 'approved' WHERE FormId='$approve_btn' ";
    ...
    if(isset($_POST['disapprove'])){
        ...
        $sql = "UPDATE Special_Exam SET status = 'disapproved' WHERE FormId='$approve_btn' ";
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">Special Form Table</h4>
                                </div><!-- end card header -->
