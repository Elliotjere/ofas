...
if (isset($_POST['reg_staff'])) {
    ...
    $query = "INSERT INTO Staff(`CheqNo`, `Name`, `Email`, `Department_DeptId`, `password`) VALUES('$CheqNo', '$name', '$email', '$department', '$password')";
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="p-2 mt-4">
                                        <form action="register.php" method="post">
                                            ...
                                            <div class="mb-3">
                                                <label for="useremail" class="form-label">Check Number <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="useremail" placeholder="Enter Check number" required name="CheqNo">
                                            ...
                                            <div class="mt-4">
                                                <button class="btn btn-success w-100" type="submit" name="reg_staff">Sign Up</button>
                                            </div>
