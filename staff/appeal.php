<?php 
    ...
    if(isset($_POST['approve'])){
        ...
        $sql = "UPDATE Appeal_Result SET status = 'approved' WHERE FormId='$approve_btn'  ";
    ...
    if(isset($_POST['disapprove'])){
        ...
        $sql = "UPDATE Appeal_Result SET status = 'disapproved' WHERE FormId='$approve_btn'  ";
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">Appeal Form report</h4>
                                </div><!-- end card header -->
                                            ...
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        echo "<td>";
                                                        echo $row['retake_semister'];
                                                        echo "</td>";

                                                        echo "<td>";
                                                        echo $row['retake_module'];
                                                        echo "</td>";
