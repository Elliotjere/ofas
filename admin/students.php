                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">View students</h4>
                                </div><!-- end card header -->
                                            ...
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="customer_name">Registration No#</th>
                                                        <th class="sort" data-sort="email">Name</th>
                                                        <th class="sort" data-sort="phone">Email</th>
                                                        <th class="sort" data-sort="date">Course</th>
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        echo" <a href='students.php'><button class='btn btn-danger' name = 'delete' value='$regno'>Remove</button></a>";
                                                        echo "</div>";
                                                        echo "</td>";
