...
if (isset($_POST['delete'])) {
    ...
    $sql = "DELETE FROM Staff WHERE CheqNo ='$cheqno'";
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">View staffs</h4>
                                </div><!-- end card header -->
                                            ...
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="customer_name">CheckNo#</th>
                                                        <th class="sort" data-sort="email">Name</th>
                                                        <th class="sort" data-sort="phone">DateOfBirth</th>
                                                        <th class="sort" data-sort="date">Email</th>
                                                        <th class="sort" data-sort="date">DateOfHire</th>
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        echo "<button type = 'submit' class='btn btn-danger' name = 'delete' value='$checkno'>Remove</button>";
                                                        echo "</div>";
                                                        echo "</div>";
                                                        echo "</td>";
                                                        echo "</form>";
