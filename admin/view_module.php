...
if (isset($_POST['delete'])) {
    ...
    $modulecode = $_POST['delete'];

    $sql = "DELETE FROM Module WHERE ModuleCode='$modulecode'";
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">View module</h4>
                                </div><!-- end card header -->
                                            ...
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="customer_name">Module Code</th>
                                                        <th class="sort" data-sort="email">Module Name</th>
                                                        <th class="sort" data-sort="phone">Module Credit</th>
                                                        <th class="sort" data-sort="status">department</th>
                                                        <th class="sort" data-sort="status">Course</th>
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        echo "</td>";
                                                        echo "<td>";
                                                        echo $row['ModuleCredit'];
                                                        echo "</td>";
                                                        echo "<td>";
                                                        echo $row['Department_DeptId'];
                                                        echo "</td>";

                                                        echo "<td>";
                                                        echo $row['Course_CourseId'];
                                                        echo "</td>";
                                        
                                                        echo "<td>";
                                                        echo "<div class='remove'>";
                                                        echo "<button type = 'submit' class='btn btn-danger' name = 'delete' value='$modulecode'>Remove</button>";
                                                        echo "</div>";
                                                        echo "</td>";
                                                        echo "</form>";
                                                        echo "</tr>";
                                                    ...
                                                    ?>
                                                        ...
                                                        if(isset($_GET['delete'])){
                                                            ...
                                                            $query = "DELETE FROM student WHERE RegNo={$the_post_id}";
