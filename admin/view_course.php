                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">View Course</h4>
                                </div><!-- end card header -->
                                            ...
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="customer_name">CourseId</th>
                                                        <th class="sort" data-sort="email">Course name</th>
                                                        <th class="sort" data-sort="phone">Course Duration</th>
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        echo "<button type ='submit' class='btn btn-danger' name='delete' value='$courseId'>Remove</button>";
                                                        echo "</div>";
                                                        echo "</td>";
                                                        echo "</form>";
                                                        echo "</tr>";
